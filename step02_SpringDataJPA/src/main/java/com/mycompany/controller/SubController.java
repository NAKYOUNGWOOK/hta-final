...
public class SubController {
	...
	//타입과 일치되는 dao 로직의 클래스를 멤버 변수로 초기화
	@Autowired
	private DeptRepository dao;
	
	//id 즉 deptno 값 받고 해당 부서 정보 모두 검색해서 json 포멧의 문자열로 반환
	//ajax설계로 간주
	//http://ip:port/step02/dept?deptno=값
	//http://localhost/step02/dept?deptno=10
	//http://13.125.208.17/step02/dept?deptno=10
	@GetMapping("/dept")
